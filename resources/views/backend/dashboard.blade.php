...
<div class="p-6 space-y-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-6">
        <!-- Total Orders -->
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-4 border-l-4 border-l-blue-600">
            <div class="w-12 h-12 bg-blue-50 rounded-xl flex items-center justify-center text-blue-600 text-xl shrink-0">
        ...
        <!-- Pending Orders -->
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-4 border-l-4 border-l-yellow-500">
            <div class="w-12 h-12 bg-yellow-50 rounded-xl flex items-center justify-center text-yellow-600 text-xl shrink-0">
        ...
        <!-- On The Way -->
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-4 border-l-4 border-l-blue-400">
            <div class="w-12 h-12 bg-blue-50 rounded-xl flex items-center justify-center text-blue-400 text-xl shrink-0">
        ...
        <!-- Rejected -->
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-4 border-l-4 border-l-red-600">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-4 bg-green-50/30">
            <div class="w-12 h-12 bg-green-100 rounded-xl flex items-center justify-center text-green-600 text-xl shrink-0">
            ...
            <div class="flex-1">
                ...
                <div class="flex items-baseline gap-3">
                    ...
                    <span class="text-sm font-bold text-green-600">{{ number_format($approvedRefundAmount, 0) }}৳</span>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-4 bg-yellow-50/30">
            <div class="w-12 h-12 bg-yellow-100 rounded-xl flex items-center justify-center text-yellow-600 text-xl shrink-0">
            ...
            <div class="flex-1">
                ...
                <div class="flex items-baseline gap-3">
                    ...
                    <span class="text-sm font-bold text-yellow-600">{{ number_format($pendingRefundAmount, 0) }}৳</span>
                </div>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="p-6 border-b border-gray-50 flex items-center justify-between">
                ...
                <a href="{{ route('admin.orders.index') }}" class="text-accent-blue text-sm font-bold hover:underline">View All</a>
            </div>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        @forelse($recentOrders as $order)
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <p class="text-sm text-gray-700">{{ $order->first_name }} {{ $order->last_name }}</p>
                                    <p class="text-xs text-gray-400">{{ $order->phone }}</p>
                                </td>
                                <td class="px-6 py-4">
                                    <p class="text-sm font-bold text-accent-orange">{{ number_format($order->total, 0) }}৳</p>
                                </td>
                                <td class="px-6 py-4">
                                    @php
                                        $statusClasses = [
                                    ...
                                    @endphp
                                    <span class="px-2 py-0.5 rounded-full text-[10px] font-bold uppercase {{ $statusClasses[$order->status] }}">
                                        {{ str_replace('_', ' ', $order->status) }}
                                    </span>
                                </td>
                                <td class="px-6 py-4">
                                    <a href="{{ route('admin.orders.show', $order->id) }}" class="text-gray-400 hover:text-accent-blue transition-colors"><i class="fas fa-eye"></i></a>
                                </td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="5" class="px-6 py-10 text-center text-gray-400 italic">No orders yet</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
            ...
            <div class="p-4 space-y-4">
                @forelse($recentUsers as $user)
                    <div class="flex items-center gap-3">
                        <div class="w-10 h-10 rounded-full bg-gradient-to-tr from-accent-orange to-orange-400 flex items-center justify-center text-white font-bold shadow-sm shrink-0">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <a href="{{ route('admin.orders.index') }}" class="p-4 rounded-xl bg-blue-50 border border-blue-100 flex flex-col items-center gap-2 group hover:bg-accent-blue transition-all">
                ...
                <a href="{{ route('admin.products.create') }}" class="p-4 rounded-xl bg-green-50 border border-green-100 flex flex-col items-center gap-2 group hover:bg-green-600 transition-all">
                ...
                <a href="{{ route('admin.banners.index') }}" class="p-4 rounded-xl bg-purple-50 border border-purple-100 flex flex-col items-center gap-2 group hover:bg-purple-600 transition-all">
        ...
        <div class="bg-gradient-to-br from-primary-dark to-gray-800 p-6 rounded-2xl shadow-xl text-white flex items-center justify-between">
            <div>
