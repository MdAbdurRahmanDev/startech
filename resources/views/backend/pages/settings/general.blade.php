...
@section('title', 'General Settings | Star Tech')
...
<div class="max-w-6xl mx-auto py-8">
    ...
    @if(session('success'))
        <div class="bg-green-50 text-green-700 p-4 rounded-lg mb-6 flex items-center gap-3 shadow-sm border border-green-100">
            ...
            <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="app_name" value="{{ old('app_name', $setting->app_name ?? '') }}" 
                                class="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-2.5 outline-none focus:border-accent-orange transition-all" placeholder="Star Tech">
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-2 flex items-center gap-5">
                                @if($setting && $setting->logo)
                                    <img src="{{ asset('storage/' . $setting->logo) }}" alt="Logo" class="h-12 w-auto object-contain border rounded p-1 bg-gray-50">
                                @endif
                                <input type="file" name="logo" class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-orange-50 file:text-accent-orange hover:file:bg-orange-100">
                            </div>
                        ...
                        <div>
                            ...
                            <div class="mt-2 flex items-center gap-5">
                                @if($setting && $setting->favicon)
                                    <img src="{{ asset('storage/' . $setting->favicon) }}" alt="Favicon" class="h-8 w-8 object-contain border rounded p-1 bg-gray-50">
                                @endif
                                <input type="file" name="favicon" class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-orange-50 file:text-accent-orange hover:file:bg-orange-100">
                            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="email" name="contact_email" value="{{ old('contact_email', $setting->contact_email ?? '') }}" 
                                class="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-2.5 outline-none focus:border-accent-orange transition-all" placeholder="info@startech.com">
                        </div>
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">Phone Number</label>
                            <input type="text" name="phone_number" value="{{ old('phone_number', $setting->phone_number ?? '') }}" 
                                class="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-2.5 outline-none focus:border-accent-orange transition-all" placeholder="16793">
                        </div>
                        <div class="md:col-span-2">
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                    ...
                    <div>
                        ...
                        <textarea name="footer_text" rows="2" class="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-2.5 outline-none focus:border-accent-orange transition-all">{{ old('footer_text', $setting->footer_text ?? '') }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-8">
                <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            <label class="block text-xs font-bold text-gray-500 uppercase mb-2">Instagram Profile</label>
                            <div class="relative">
                ...
                <div class="sticky top-24">
                    <button type="submit" class="w-full bg-primary-dark text-white font-bold py-4 rounded-xl shadow-lg hover:shadow-xl hover:bg-opacity-95 transition-all flex items-center justify-center gap-3 text-lg">
                        <i class="fas fa-save"></i>
                        Update Settings
                    </button>
                    <p class="text-center text-xs text-gray-400 mt-4 italic">Last updated: {{ $setting ? $setting->updated_at->diffForHumans() : 'Never' }}</p>
                </div>
            </div>
        </div>
    </form>
