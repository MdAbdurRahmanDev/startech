...
<div class="p-6">
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-bold text-gray-800">Add New Outlet</h2>
    ...
    <form action="{{ route('admin.outlets.store') }}" method="POST" class="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
        @csrf
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="name" placeholder="e.g. Narayanganj Branch" required
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="timing" placeholder="e.g. 9 AM - 7 PM" required
                               class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                    <div>
                        <label class="block text-sm font-bold text-gray-700 mb-1">Off Day <span class="text-red-500">*</span></label>
                        <input type="text" name="off_day" placeholder="e.g. Friday Off" required
                               class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <input type="url" name="map_link" placeholder="Google Maps URL..."
                           class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>

                <div class="flex items-center gap-6 pt-2">
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="status" checked class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                        <span class="text-sm font-bold text-gray-700">Active</span>
                    </label>
                    <div class="flex items-center gap-2">
                        <span class="text-sm font-bold text-gray-700">Sort Order:</span>
                        <input type="number" name="sort_order" value="0" class="w-20 border border-gray-300 rounded-lg px-2 py-1 text-sm focus:outline-none">
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 gap-4">
                    <div>
                        ...
                        <input type="text" name="phones[desktop_1]" placeholder="Desktop 1 phone number..."
                    ...
                    <div>
                        ...
                        <input type="text" name="phones[desktop_2]" placeholder="Desktop 2 phone number..."
                               class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-500 mb-1 uppercase">Laptop Phone</label>
                        <input type="text" name="phones[laptop]" placeholder="Laptop phone number..."
                               class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-500 mb-1 uppercase">Accessories Phone</label>
                        <input type="text" name="phones[accessories]" placeholder="Accessories phone number..."
                               class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-500 mb-1 uppercase">Corporate Deal</label>
                        <input type="text" name="phones[corporate]" placeholder="Corporate deal phone number..."
                               class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm">
                    </div>
                </div>
            </div>
