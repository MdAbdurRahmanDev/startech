        ...
        <form action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-6">
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900">Product Name <span
                        ...
                        <!-- Categories -->
                        <div class="mt-6 mb-4">
                            <label class="block text-sm font-medium text-gray-700 mb-2">Categories <span
                                    class="text-red-500">*</span></label>
                        ...
                        <div>
                            ...
                            <input type="text" name="tags" value="{{ old('tags', $product->tags) }}"
                                placeholder="Comma separated tags e.g. gaming, laptop, asus"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5">
                            @error('tags')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="space-y-2">
                                @if ($product->video)
                                    <div class="flex items-center gap-3 p-2 bg-gray-50 rounded border border-gray-100">
                                        ...
                                        <span
                                            class="text-xs text-gray-600 truncate max-w-[200px]">{{ basename($product->video) }}</span>
                                        <a href="{{ asset('storage/' . $product->video) }}" target="_blank"
                                            class="text-[10px] bg-blue-100 text-blue-600 px-2 py-0.5 rounded font-bold hover:bg-blue-200 transition-colors">View
                                            Current</a>
                                    </div>
                                @endif
                            ...
                            <p class="text-[10px] text-gray-400 mt-1">Accepted formats: MP4, MOV, QT. Max size: 20MB. Leave
                        ...
                        <div class="flex items-center gap-3 pt-2">
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" name="is_coming_soon" value="1" class="sr-only peer"
                                    {{ old('is_coming_soon', $product->is_coming_soon) ? 'checked' : '' }}>
                                <div
                                    class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600">
                                </div>
                                <span class="ml-3 text-sm font-medium text-gray-900">Coming Soon</span>
                            </label>
                        </div>

                        <div class="flex items-center gap-3 pt-2">
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" name="is_tba" value="1" class="sr-only peer"
                                    {{ old('is_tba', $product->is_tba) ? 'checked' : '' }}>
                                <div
                                    class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600">
                                </div>
                                <span class="ml-3 text-sm font-medium text-gray-900">To Be Announced</span>
                            </label>
                        </div>

                        <div class="flex items-center gap-3 pt-2">
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" name="is_call_for_price" value="1" class="sr-only peer"
                                    {{ old('is_call_for_price', $product->is_call_for_price) ? 'checked' : '' }}>
                                <div
                                    class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600">
                                </div>
                                <span class="ml-3 text-sm font-medium text-gray-900">Call for Price</span>
                            </label>
                        </div>

                        <div class="flex items-center gap-3 pt-2">
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" name="is_out_of_stock" value="1" class="sr-only peer"
                                    {{ old('is_out_of_stock', $product->is_out_of_stock) ? 'checked' : '' }}>
                                <div
                                    class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600">
                                </div>
                                <span class="ml-3 text-sm font-medium text-gray-900">Out of Stock (Manual)</span>
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-900">Buy Price (Cost) <span
                                class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-900">Regular Price (Sell) <span
                                class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-900">Stock Quantity <span
                                class="text-red-500">*</span></label>
            ...
            <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                <div class="mb-4 border-b pb-2">
                    ...
                    <p class="text-xs text-gray-500 mt-1">Use the editor below to write full product specifications. You
                        can use headings, tables, bold text, and lists.</p>
                </div>
            ...
            <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-6">
                        ...
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900">Meta Image (For Social
                                Sharing)</label>
