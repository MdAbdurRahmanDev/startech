            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <select name="categories[]" id="categories" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5" multiple="multiple" required>
                ...
                @if($product->specifications && $product->specifications->count() > 0)
                    @foreach($product->specifications as $index => $spec)
                        <div class="flex gap-4 items-start spec-row">
                            <div class="w-1/3">
                                <input type="text" name="specifications[{{ $index }}][name]" value="{{ $spec->name }}" placeholder="Specification Name (e.g. Processor)" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5">
                            </div>
                            <div class="w-2/3 flex gap-2">
                                <input type="text" name="specifications[{{ $index }}][value]" value="{{ $spec->value }}" placeholder="Value (e.g. Intel Core i5 12th Gen)" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5">
                    ...
                    @endforeach
                @else
                    <!-- Initial Specification Row if none exist -->
                    <div class="flex gap-4 items-start spec-row">
                        <div class="w-1/3">
...
<script>
    $(document).ready(function() {
        ...
        let specIndex = {{ max(1, $product->specifications ? $product->specifications->count() : 1) }};
