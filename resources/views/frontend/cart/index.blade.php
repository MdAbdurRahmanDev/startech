...
<div class="container pb-14">
    ...
    @if(count($cart) > 0)
        <div class="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-6 items-start">
            ...
            <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                <div class="hidden md:grid grid-cols-[2fr_1fr_1fr_1fr_40px] bg-[#f2f4f8] text-[13px] font-bold text-gray-600 px-5 py-3">
                    <div>Product</div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr_1fr_40px] items-center px-5 py-4 border-b border-gray-100 last:border-b-0 gap-4" id="cart-row-{{ $id }}">
                    <!-- Product -->
                    ...
                    <!-- Unit Price -->
                    <div class="text-center text-[14px] font-bold text-accent-orange md:block flex items-center gap-2">
                    ...
                    <div class="flex items-center justify-center md:justify-center gap-2">
                        <div class="flex items-center border border-gray-300 rounded overflow-hidden">
                            <button onclick="updateQty({{ $id }}, -1)" class="px-2.5 py-1.5 bg-gray-50 hover:bg-gray-100 transition-colors text-[16px] leading-none text-gray-700">−</button>
                    ...
                    <div class="text-center text-[14px] font-bold text-gray-800 md:block flex items-center gap-2">
                        ...
                        <span id="subtotal-{{ $id }}">{{ number_format($item['price'] * $item['quantity'], 0) }}৳</span>
                    </div>
                ...
                <div class="flex flex-wrap justify-between items-center px-5 py-4 bg-[#f9fafb] gap-3">
                    <a href="{{ url('/') }}" class="border border-gray-300 text-gray-700 py-2 px-5 rounded text-[13px] font-semibold hover:border-accent-blue hover:text-accent-blue transition-colors flex items-center gap-2">
                        <i class="fas fa-arrow-left text-[11px]"></i> Continue Shopping
                    </a>
                    <button onclick="clearCart()" class="border border-red-300 text-red-500 py-2 px-5 rounded text-[13px] font-semibold hover:bg-red-50 transition-colors flex items-center gap-2">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                ...
                <div class="space-y-3 mb-5">
                    <div class="flex justify-between text-[14px] text-gray-600">
                        <span>Subtotal</span>
                        <span id="order-total" class="font-semibold text-gray-800">{{ number_format($total, 0) }}৳</span>
                    </div>
                    <div class="flex justify-between text-[14px] text-gray-600">
                        <span>Shipping</span>
                ...
                <a href="{{ route('cart.checkout') }}" class="bg-accent-blue text-white py-3 px-6 rounded font-bold w-full text-center transition-colors hover:bg-accent-orange shadow-sm flex items-center justify-center gap-2 mb-3">
                ...
                <div class="mt-5 pt-4 border-t border-gray-100">
                    ...
                    <div class="flex flex-wrap gap-2 justify-center">
                        <span class="border border-gray-200 rounded px-2 py-1 text-[11px] font-bold text-gray-600">Cash</span>
                        <span class="border border-gray-200 rounded px-2 py-1 text-[11px] font-bold text-gray-600">bKash</span>
                        <span class="border border-gray-200 rounded px-2 py-1 text-[11px] font-bold text-gray-600">Nagad</span>
                        <span class="border border-gray-200 rounded px-2 py-1 text-[11px] font-bold text-gray-600">Visa / MC</span>
                        <span class="border border-gray-200 rounded px-2 py-1 text-[11px] font-bold text-gray-600">0% EMI</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    @else
        ...
        <div class="bg-white rounded-lg shadow-sm p-16 text-center">
            ...
            <a href="{{ url('/') }}" class="bg-accent-blue text-white py-3 px-10 rounded font-bold transition-colors hover:bg-accent-orange inline-flex items-center gap-2">
