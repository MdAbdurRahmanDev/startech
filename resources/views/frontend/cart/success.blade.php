...
@section('content')
    <div class="container py-16">
        <div class="max-w-xl mx-auto text-center">
            ...
            <p class="text-gray-600 mb-8">Your order has been placed successfully. Our team will contact you shortly for
                confirmation.</p>
            ...
            <div class="bg-gray-50 border border-gray-200 rounded-lg p-6 mb-8 text-left">
                ...
                <div class="flex justify-between mb-2">
                    ...
                    <span
                        class="px-2 py-0.5 bg-yellow-100 text-yellow-800 rounded text-xs font-bold uppercase">{{ $order->status }}</span>
                </div>
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="{{ url('/') }}"
                    class="bg-accent-blue text-white px-8 py-3 rounded font-bold hover:bg-blue-700 transition-colors">
                    Continue Shopping
                </a>
                <a href="{{ route('user.order') }}"
                    class="bg-white border border-gray-300 text-gray-700 px-8 py-3 rounded font-bold hover:bg-gray-50 transition-colors">
                    View My Orders
                </a>
            </div>
        </div>
