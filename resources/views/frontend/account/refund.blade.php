...
@section('title', 'Request Refund | IOS BD')
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div class="p-6">
            <div class="bg-blue-50 border border-blue-100 rounded-xl p-4 mb-8 flex items-start gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-blue-600 mt-1 leading-relaxed">
                        ...
                        Please provide a valid reason for your refund request. Our team will review your request and get
            ...
            <form action="{{ route('user.order.refund.store', $order->id) }}" method="POST">
                ...
                <div class="space-y-6">
                    <div>
                        <label class="block text-sm font-bold text-gray-700 mb-2">Reason for Refund <span
