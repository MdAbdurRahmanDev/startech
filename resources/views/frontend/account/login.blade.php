        ...
        <div class="bg-white p-8 md:p-10 rounded-2xl shadow-xl border border-gray-100 animate-fade-in">
            ...
            <form action="{{ route('user.login.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="login_identity" value="{{ old('login_identity') }}" placeholder="Phone / E-Mail" class="w-full bg-gray-50 border @error('login_identity') border-red-500 @else border-gray-200 @enderror rounded-xl px-5 py-3.5 outline-none focus:border-accent-orange focus:ring-4 focus:ring-orange-50 transition-all text-sm shadow-sm" required autofocus>
                ...
                <div>
                    <div class="flex justify-between items-center mb-2">
                        ...
                        <a href="#" class="text-xs text-accent-orange font-semibold hover:underline">Forgotten Password?</a>
                    </div>
                ...
                <div class="flex items-center gap-2">
                    <input type="checkbox" name="remember" id="remember" class="w-4 h-4 text-accent-orange border-gray-300 rounded focus:ring-accent-orange">
            ...
            <div class="mt-8 pt-8 border-t border-gray-100 text-center">
                ...
                <a href="{{ url('/account/register') }}" class="inline-block text-accent-blue font-bold hover:text-primary-dark transition-colors border-b-2 border-accent-blue/30 hover:border-accent-blue pb-0.5">
                    Create Your Account
                </a>
            </div>
        </div>
