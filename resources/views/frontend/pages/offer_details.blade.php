...
@section('title', $offer->title . ' | Star Tech')
...
<div class="container mx-auto px-2 md:px-4 mb-10">
    ...
    <div class="py-4 text-[13px] text-gray-500">
        ...
        <span class="mx-1">/</span> <a href="{{ route('offers.index') }}" class="text-gray-700 hover:text-accent-orange transition-colors">Offer</a>
    ...
    <div class="max-w-4xl mx-auto bg-white rounded-lg shadow-sm border border-gray-50 overflow-hidden">
        ...
        <div class="p-6 border-b border-gray-50 flex flex-col md:flex-row justify-between items-center gap-4">
            <div class="flex items-center gap-3">
                <a href="{{ route('offers.index') }}" class="text-primary-dark hover:text-accent-orange transition-colors text-xl">
            ...
            <div class="flex items-center gap-3" id="countdown-timer">
                ...
                <div class="flex gap-1.5">
                    <div class="bg-accent-orange text-white w-10 h-12 rounded flex flex-col items-center justify-center shadow-sm">
        ...
        <div class="p-6 md:p-8">
            ...
            <div class="flex flex-wrap items-center gap-6 mb-8 py-4 border-y border-gray-50 text-sm text-gray-600">
                <div class="flex items-center gap-2">
                    ...
                    <span class="font-bold">{{ $offer->start_date->format('d M Y') }} - {{ $offer->end_date->format('d M Y') }}</span>
                </div>
                <div class="flex items-center gap-2">
...
<script>
    ...
    const x = setInterval(function() {
        ...
        if (distance < 0) {
            clearInterval(x);
            document.getElementById("countdown-timer").innerHTML = "<span class='text-red-500 font-bold'>OFFER EXPIRED</span>";
        }
    }, 1000);
</script>
<style>
    .offer-content p { margin-bottom: 1.5rem; }
    .offer-content h2 { font-size: 1.5rem; font-weight: bold; margin: 2rem 0 1rem; color: #374151; }
    .offer-content ul { list-style: disc; margin-left: 1.5rem; margin-bottom: 1.5rem; }
