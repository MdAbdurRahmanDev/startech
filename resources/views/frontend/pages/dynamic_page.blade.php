        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-12 mb-10 min-h-[500px]">
            ...
            @else
                <div class="flex flex-col items-center justify-center py-20 text-center">
                    ...
                    <p class="text-gray-500 max-w-md">Content for this page is currently being prepared. Please check back
                        later.</p>
                    <a href="{{ url('/') }}"
                        class="mt-8 bg-accent-blue text-white px-8 py-3 rounded-lg font-bold hover:bg-opacity-90 transition-all shadow-md">Back
                        to Home</a>
                </div>
            @endif
        </div>
