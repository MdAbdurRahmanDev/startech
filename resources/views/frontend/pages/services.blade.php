...
@section('title', 'Our Services | IOS BD')
...
@section('content')
    <div class="container mx-auto px-2 md:px-4 mb-10">
        ...
        <div class="text-center mb-12">
            ...
            <p class="text-gray-600 max-w-2xl mx-auto">We provide premium digital solutions to help your business grow.
                Explore our specialized services below.</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            @forelse($services as $service)
                <div
                    class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden flex flex-col hover:shadow-xl transition-all duration-300 group">
                    <!-- Service Banner -->
                    <a href="{{ route('services.show', $service->slug) }}"
                        class="block relative aspect-[4/3] overflow-hidden bg-neutral-primary-soft">
                        @if ($service->image)
                        ...
                        @endif
                        <div
                            class="absolute top-4 right-4 bg-accent-orange text-white text-[10px] font-bold px-3 py-1 rounded-full z-10 shadow-sm uppercase tracking-wider">
                            Premium Service
                        </div>
                    </a>
                    ...
                    <div class="p-6 flex flex-col flex-grow">
                        ...
                        <h2
                            class="text-[20px] font-bold text-primary-dark mb-3 group-hover:text-accent-blue transition-colors line-clamp-2 min-h-[60px]">
                            {{ $service->title }}</h2>
                        ...
                        <div class="mt-auto">
                            <a href="{{ route('services.show', $service->slug) }}"
                                class="inline-block bg-accent-blue text-white px-8 py-2.5 rounded-lg font-bold text-sm hover:bg-opacity-90 transition-all shadow-md">
                                View Details
                            </a>
                        </div>
                    </div>
